<template>
  ...
  >
    ...
    <ul class="d-flex flex-wrap justify-content-center">
      ...
      >
        <li class="date day">Lun</li>
        <li class="date day">Mar</li>
        <li class="date day">Mer</li>
        <li class="date day">Jeu</li>
        <li class="date day">Ven</li>
        <li class="date day">Sam</li>
        <li class="date day">Dim</li>
      </div>
      <li
